  ...
  return (
    <div className='container-button'>
        ...
        <div className='toolkit'>
            ...
            <ModalComponent direccion={"/Administrar"} icon={deletes}></ModalComponent>
